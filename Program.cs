...
namespace BlackJack
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string[] hearts = Enumerable.Range(2, 9).Select(x => x.ToString() + "♥").ToArray();
            ...
            string[] diamonds = Enumerable.Range(2, 9).Select(x => x.ToString() + "♦").ToArray();
            ...
            string[] clubs = Enumerable.Range(2, 9).Select(x => x.ToString() + "♣").ToArray();
            ...
            string[] spades = Enumerable.Range(2, 9).Select(x => x.ToString() + "♠").ToArray();
        ...
        {
            string faceValue = c.Replace(("♥").ToString(), "").Replace(("♦").ToString(), "").Replace(("♣").ToString(), "").Replace(("♠").ToString(), "");
            int value;
